...
Getting Started
Build the salt minion as salt-minion1 and the salt master as salt-master1.  You can run docker build -t salt-minion1 or salt-master1 . in the correct directory   After that is complete run docker-compose up -d.
